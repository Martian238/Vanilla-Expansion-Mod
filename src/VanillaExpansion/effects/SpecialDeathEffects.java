...
import VanillaExpansion.expand.graphics.VaporizeBatch.*;
...
public class SpecialDeathEffects{
    ...
    public Effect debrisEffect = VEFX.heavyDebris, sparkEffect = VEFX.destroySparks, explosionEffect = Fx.none;
    ...
    public static void load(){
        ...
        blood = new OrganicDeath(){{
            color.set(VEPal.blood);
            internalColor = VEPal.blood;
            colorVariation = 0.2f;
        ...
        OrganicDeath nha = new OrganicDeath(){{
            ...
            explosionEffect = new MultiEffect(VEFX.fragmentExplosion, lightning);
        }};
        ...
        OrganicDeath end = new OrganicDeath(){{
            ...
            explosionEffect = VEFX.fragmentExplosion;
        }};
